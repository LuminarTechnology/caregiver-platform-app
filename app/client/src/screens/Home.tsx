  ...
  return (
    <View className="flex-1 bg-white">
      <ScrollView className="bg-white" showsVerticalScrollIndicator={false}>
        ...
        <CareSelection selectedCare={selectedCare} onSelectCare={setSelectedCare} />
        <Banner onGetStarted={handleGetStarted} />
        <CaregiversSection caregivers={caregivers} onCaregiverPress={handleCaregiverPress} />
        <ArticlesSection articles={articles} onArticlePress={handleArticlePress} />
      </ScrollView>
    </View>
  );
};
